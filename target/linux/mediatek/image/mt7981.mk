...
define Device/qihoo-360-t7
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += qihoo-360-t7

define Device/qihoo-360-t7-108M
  DEVICE_VENDOR := Qihoo
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += qihoo-360-t7-108M
...
define Device/zbtlink_zbt-z8103ax-c-nmbm
  ...
  DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
  SUPPORTED_DEVICES := zbtlink,zbt-z8103ax-c-nmbm
  DEVICE_PACKAGES := $(MT7981_USB_PKGS) luci-app-samba4
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
